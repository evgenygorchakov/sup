...
export interface ConfigShape {
  ...
  WEB_SEARCH_RESULT_CHARS: number
  FETCH_URL_MAX_BYTES: number
  FETCH_URL_TIMEOUT_MS: number
  FETCH_URL_CACHE_TTL_MS: number
  FETCH_URL_OUTLINE_MAX_ENTRIES: number
...
export const Config: ConfigShape = {
  ...
  USE_STT: getEnvBoolean('USE_STT', false),
  ...
  WEB_SEARCH_MAX_RESULTS: getEnvNumber('WEB_SEARCH_MAX_RESULTS', 10),
  WEB_SEARCH_RESULT_CHARS: getEnvNumber('WEB_SEARCH_RESULT_CHARS', 0),
  FETCH_URL_MAX_BYTES: getEnvNumber('FETCH_URL_MAX_BYTES', 2_000_000),
  FETCH_URL_TIMEOUT_MS: getEnvNumber('FETCH_URL_TIMEOUT_MS', 15_000),
  FETCH_URL_CACHE_TTL_MS: getEnvNumber('FETCH_URL_CACHE_TTL_MS', 900_000),
  FETCH_URL_OUTLINE_MAX_ENTRIES: getEnvNumber('FETCH_URL_OUTLINE_MAX_ENTRIES', 60),
